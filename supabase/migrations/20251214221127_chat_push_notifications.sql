-- Push Notifications para Chat
-- Envia notificação quando usuário recebe nova mensagem

-- Função para enviar push de nova mensagem de chat
...
BEGIN
  ...
  PERFORM net.http_post(
    ...
    headers := jsonb_build_object(
      ...
      'Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxsd3RtdnBjcm5qeG1ydXh6emdiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzI4MjA2NjIsImV4cCI6MjA0ODM5NjY2Mn0.dG0Qk_s-Uy7lLSxPJKPJPKPJPKPJPKPJPKPJPKPJPKP'
    ),
...
-- Trigger para enviar push quando mensagem é criada
DROP TRIGGER IF EXISTS trigger_chat_push_notification ON mensagens;
